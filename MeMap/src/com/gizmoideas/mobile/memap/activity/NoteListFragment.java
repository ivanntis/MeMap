...
public class NoteListFragment extends ListFragment {
	 ...
	 * clicks.
	 */
	private Callbacks mCallbacks = noteCallbacks;
	 ...
	 */
	private static Callbacks noteCallbacks = new Callbacks() {
		@Override
		public void onItemSelected(String id) {
		}
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<Note>(getActivity(),
				...
				android.R.id.text1, NoteContent.NOTES));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(NoteContent.NOTES.get(position).getId()+"");
	}
